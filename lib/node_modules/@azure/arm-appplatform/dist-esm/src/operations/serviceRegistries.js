...
export class ServiceRegistriesImpl {
    ...
    beginCreateOrUpdate(resourceGroupName, serviceName, serviceRegistryName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serviceName, serviceRegistryName, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, serviceName, serviceRegistryName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serviceName, serviceRegistryName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
