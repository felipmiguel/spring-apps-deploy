...
export class GatewaysImpl {
    ...
    get(resourceGroupName, serviceName, gatewayName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, gatewayName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, serviceName, gatewayName, gatewayResource, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serviceName, gatewayName, gatewayResource, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, serviceName, gatewayName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serviceName, gatewayName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    validateDomain(resourceGroupName, serviceName, gatewayName, validatePayload, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, gatewayName, validatePayload, options }, validateDomainOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
